...
<t:templetepage>
    ...
    <jsp:body>
    	<link href="<c:url value="Modules/TopicArticleDisplay.css"/>" rel="stylesheet" type="text/css" />
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
					...
					<span id="ctl06_ctl01_RadCaptcha1_ctl00" style="color:Red;visibility:hidden;"></span><div id="ctl06_ctl01_RadCaptcha1_SpamProtectorPanel">
						<img id="ctl06_ctl01_RadCaptcha1_CaptchaImage" alt="" src="Telerik.Web.UI.WebResourcedb99.jpg?type=rca&amp;guid=637fbc90-4ed2-47e4-89e4-c0a0bc3fb684" style="height:50px;width:150px;border-width:0px;display:block;" />
